<?php /* Smarty version 2.6.22, created on 2009-01-12 08:56:09
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'index.tpl', 1, false),array('modifier', 'date_format', 'index.tpl', 25, false),)), $this); ?>
...
"><?php echo $this->_config[0]['vars']['operation']; ?>
 ...
 <?php endfor; else: ?>
 <tr>
 <td colspan="4"><?php echo $this->_config[0]['vars']['notopic']; ?>
</td>
 </tr>
 <?php endif; ?> 
 </div>
