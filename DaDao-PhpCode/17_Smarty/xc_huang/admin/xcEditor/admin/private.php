...
function eWebEditor_Footer(){
	echo "<table border=0 cellpadding=0 cellspacing=0 align=center width='100%'>"
		...
		."<tr>"
			."<td align=center>Copyright  &copy;  2008-2009  <b>idc999<font color=#CC0000>.com</font>九九久联网络<font color=#CC0000>.com</font></b>, All Rights Reserved .</td>"
		."</tr>"
		."<tr>"
			."<td align=center><a href='mailto:xc_huang5849@sina.com'>xc_huang5849@sina.com</a></td>"
		."</tr>"
		."</table>";
