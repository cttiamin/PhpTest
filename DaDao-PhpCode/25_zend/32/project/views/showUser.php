      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
              <td align="center"><p>
              <table width="329" height="162" border="1" align="center">
	<tr>
	
	<td width="33"><span class="STYLE12">用户编号</span></td>
	<td width="42"><span class="STYLE12">用户名称</span></td>
	<td width="79"><span class="STYLE12">用户密码</span></td>	
    <td width="114"><span class="STYLE12">操作</span></td>
   </tr>

<?php
$user=new UserInfo();
$array=array();
$array=$_SESSION['allUser'];
for($i=0;$i<count($array); $i++){
$user= $array[$i];
?>
	<tr>
	<td><span class="STYLE10">
	  <?php  echo $user->getUserNo();?>
	</span></td>
	<td><span class="STYLE10">
	...
	<td>
	  <span class="STYLE12"><a href="../controllers/UserInfoController.php?action=removeUser&id=<?php  echo $user->getId();?>" >
	删除</a>
	  <a href="../controllers/UserInfoController.php?action=findOneUser&id=<?php  echo $user->getId();;?>" >
	更新	  </a>	  </span></td></tr>	        
<?php } ?>

</table>	
<a href="register.php">添加用户</a>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p><br>
...
<!--Something Here-->
        ...
        <tr> 
          <td> <table width="190" border="0" cellspacing="0" cellpadding="0" height="46" background="images/index_lm.gif">
              <tr> 
                <td> 
