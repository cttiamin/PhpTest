      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
              <td >
			  <form action="com/sunyang/controllers/LoginController.php" method="post">
                <div align="center">
                  <!--SubButton1-->  
                  <span class="STYLE8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE9"> 增加产品页面			    </span></span>                  </div>
			  </form></td>
            </tr>
            <tr>
...
<tr>
<td><span class="STYLE6">用户编号：</span></td>
<td><input type="text" name="userno" ></td>
</tr>

<tr>
<tr>
<td><span class="STYLE6">用户名称：</span></td>
<td><input type="text" name="username" ></td>
</tr>

<td><span class="STYLE6">用户密码：</span></td>
