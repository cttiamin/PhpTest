...
<form id="frmname" name="frmname" method="post" action="article_del.asp?s_id=<%=s_id%>">
  <tr>
    <td width="7%" align="center" bgcolor="#6699FF">
	<input type="checkbox" name="check1" value="checkbox" onclick="return checkall();" /></td>
    <td width="53%" align="center" bgcolor="#6699FF">标题</td>
    <td width="8%" align="center" bgcolor="#6699FF">显示</td>
    <td width="10%" align="center" bgcolor="#6699FF">推荐</td>
    <td width="8%" align="center" bgcolor="#6699FF">ID</td>
    <td width="6%" align="center" bgcolor="#6699FF">图片</td>
    <td width="8%" align="center" bgcolor="#6699FF">操作</td>
  </tr>
  <%
  ...
  <tr>
    <td colspan="7"><div align="center">没有内容</div></td>
  </tr>
  <%
  else
  ...
  %>
	    ...
	    <td colspan="6" align="center"><a href="?page=1&amp;s_id=<%=s_id%>">
