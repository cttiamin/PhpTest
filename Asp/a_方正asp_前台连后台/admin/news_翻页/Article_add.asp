...
重点推荐</td>
    ...
    <tr>
      ...
      <td><input name="a_content" type="hidden" id="a_content" />
      <IFRAME ID="eWebEditor1" SRC="../ewebeditor/ewebeditor.asp?id=a_content&style=mpn" FRAMEBORDER="0" SCROLLING="no" WIDTH="650" HEIGHT="300"></IFRAME>
    ...
    <tr>
      ...
      <td>
	  <input name="picture" type="text" id="picture" size="36"> 
