...
const SaveUpFilesPath="/uppic_links"
      ...
      <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="2">
        <tr>
		  ...
		  if PhotoUrlID=0 then
		   	response.write "<a href='#' onClick=""javascript:window.opener.document.editform.previewimg.value='" & SavePath & theFile.Name & "';window.close();"">"
		  end if
		  if PhotoUrlID=1 then
		   	response.write "<a href='#' onClick=""javascript:window.opener.document.editform.Team_texPic.value='" & SavePath & theFile.Name & "';window.close();"">"
		  end if
		  if PhotoUrlID=2 then
		   	response.write "<a href='#' onClick=""javascript:window.opener.document.editform.PicUrl2.value='" & SavePath & theFile.Name & "';window.close();"">"
		  end if
